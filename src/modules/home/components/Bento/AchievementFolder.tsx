...
import Folder from '@/src/common/components/elements/Folder';
import Image from '@/src/common/components/elements/Image';
import { AchievementItem } from '@/src/common/types/achievements';
...
const AchievementFolder = () => {
  ...
  return (
    <div className="mb-4 mt-8 flex w-full items-center justify-center">
      <Folder size={0.8} color="#facc15" items={items} />
    </div>
  );
};
